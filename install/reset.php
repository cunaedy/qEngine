...
if ($config['demo_mode']) {
    ...
    $folders = array('file', 'image', 'thumb');
    ...
    sql_query("INSERT INTO ".$db_prefix."user SET user_id = 'admin', user_passwd = '$admin_passwd', user_email = 'demo@c97.net', user_level = '5', user_since = '$today', admin_level = '5'");

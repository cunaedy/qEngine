...
<script type="text/javascript" src="{$site_url}/misc/tinymce/tinymce.min.js"></script>
...
tinymce.init({
	...
	plugins: "advlist autolink lists link image charmap print preview anchor searchreplace visualblocks code fullscreen pagebreak insertdatetime media table contextmenu paste emoticons textcolor help wordcount",
	toolbar: "undo redo | styleselect | bold italic forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | emoticons",
...
<!-- BEGINIF $rte_mode == 'rte_inline_init' -->
<script type="text/javascript" src="{$site_url}/misc/tinymce/tinymce.min.js"></script>
<script type="text/javascript">
// TinyMCE is (c)copyright Moxiecode Systems AB -- http://www.tinymce.com
tinymce.init({
	...
	inline: true,
	file_browser_callback: SimpleFileBrowser,
	plugins: "advlist autolink lists link image charmap print preview anchor searchreplace visualblocks code fullscreen pagebreak insertdatetime media table contextmenu paste emoticons textcolor help wordcount save",
	toolbar: "save | undo redo | styleselect | bold italic forecolor backcolor | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | emoticons",
	menubar: "edit view insert format table help",
	link_context_toolbar: true,
	zsetup: function(editor){
		editor.on('init', function() {
			$(editor.getBody()).on('click', 'a[href]', function(e) { window.location.href = $(e.currentTarget).attr('href') });
		})
	}
});
...
<!-- BEGINIF $rte_mode == 'rte_inline_multi' -->
<!-- ENDIF -->

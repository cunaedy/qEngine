...
function quick_tpl($tpl, $text)
{
    ...
    $text['current_skin'] = $config['current_skin'];
...
// $mode = user (default), print, popup; admin (adm), adm_print, adm_popup; _blank (without body tpl), ajax, _empty (_empty & ajax without any outline.tpl)
...
function flush_tpl($mode = 'user', $subtpl = '', $as_string = false)
{
